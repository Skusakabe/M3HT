...
var dvdLogoSetup = function () {
    ...
    var rectX = Math.floor(Math.random() * (ctx.width - rectWidth));
    var rectY = Math.floor(Math.random() * (ctx.height - rectHeight));

    var xVel = Math.floor(Math.random() * 8);
    var yVel = Math.floor(Math.random() * 8);
